...
class InfiniteGridMenu {
  ...
  private render(): void {
    ...
    gl.uniformMatrix4fv(
      ...
      false,
      new Float32Array(this.worldMatrix as any)
    );
    gl.uniformMatrix4fv(
      this.discLocations.uViewMatrix,
      false,
      new Float32Array(this.camera.matrices.view as any)
    );
    gl.uniformMatrix4fv(
      this.discLocations.uProjectionMatrix,
      false,
      new Float32Array(this.camera.matrices.projection as any)
    );
    gl.uniform3f(
  ...
  return (
    <div className="relative w-full h-full ">
      <canvas
        ...
        ref={canvasRef}
        className="bg-transparent cursor-grab w-full h-full overflow-hidden relative outline-none active:cursor-grabbing"
      />
      ...
      {activeItem && (
        ...
        `}
          ...
          ${isMoving ? "duration-[100ms]" : "duration-[500ms]"}
